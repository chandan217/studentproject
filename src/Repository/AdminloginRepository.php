 ...
 */
class AdminloginRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    public function add(Adminlogin $entity, bool $flush = false): void
    {
    ...
    public function remove(Adminlogin $entity, bool $flush = false): void
    {
